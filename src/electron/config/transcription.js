/**
 * Transcription configuration for Electron services
 * Defines available models and their capabilities
 * 
 * Note: This config mirrors frontend/src/lib/config.js TRANSCRIPTION section
 * and backend/src/config/transcription.js for consistency across the application
 */
